        ...
        context "project with software" do
          ...
          context "with default bin_dirs and lib_dirs" do
            ...
            context "with library" do
              ...
              it "returns a set with the signed library" do
                expect(subject.sign_software_libs_and_bins).to eq(Set.new [lib])
              end
            end
            ...
            context "with binaries and libraries with linked libs" do
              ...
              it "returns a set with the signed files" do
                expect(subject.sign_software_libs_and_bins).to eq(Set.new [lib, lib2, bin, bin2, embedded_bin])
              end
            end
          end
        end
